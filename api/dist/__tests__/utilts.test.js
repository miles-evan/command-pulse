...
describe("generateUniqueCode", () => {
    ...
    it("ensures code is unique across officerInviteCode and supervisorInviteCode", async () => {
        ...
        expect(exists).toHaveBeenCalledWith(expect.objectContaining({ officerInviteCode: expect.any(String) }));
        expect(exists).toHaveBeenCalledWith(expect.objectContaining({ supervisorInviteCode: expect.any(String) }));
    });
