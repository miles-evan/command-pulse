...
const incidentReportStructure = JSON.stringify({
    ...
    structure: [
        ...
        { "incident resolution & follow-up": "final actions taken, including arrests, emergency responses, or if further investigation is needed"
        },
...
const promptHeader = "You're a security assistant helping write professional incident reports in markdown.";
const markDownExplanation = "When generating the markdown, try to include #s, ##s, and **s when it would make it look good.";
// --------------------------------
