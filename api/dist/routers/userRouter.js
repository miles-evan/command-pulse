...
// --------------------------------
// Sign up
userRouter.post("/signup", ...validateRequest(signupValidation), async (request, response) => {
...
// Login
userRouter.post("/login", ...validateRequest(loginValidation), passport.authenticate("local"), (request, response) => {
...
userRouter.get("/check-email/:email", validateRequest(checkEmailAvailabilityValidation), async (request, response) => {
