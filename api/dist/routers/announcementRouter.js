...
// --------------------------------
// Send announcement
announcementRouter.post("/", ...validateRequest(sendAnnouncementValidation), ...permission("supervisor"), async (request, response) => {
...
// Get announcements
announcementRouter.get("/", ...validateRequest(getAnnouncementsValidation), ...permission("in company"), async (request, response) => {
